...
export const SEED_USERS: Omit<NewUser, "id" | "emailVerified" | "createdAt" | "updatedAt">[] = [
  ...
  },
  {
    ...
    relationshipIntent: "open_to_both", relationshipStyle: "ethical_non_monogamous",
  ...
  },
  {
    ...
    relationshipIntent: "dating", relationshipStyle: "open",
  ...
  },
  {
    ...
    relationshipIntent: "dating", relationshipStyle: "monogamous",
    hasChildren: "no", wantsChildren: "yes",
    smoking: "never", drinking: "sometimes", activityLevel: "active", religion: "none",
