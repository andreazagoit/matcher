...
Endpoints:
  POST /embed  — generate a 256-dim embedding from raw entity data (stateless, no DB)
...
from ml.modeling.hgt import HetEncoder
...
class EmbedResponse(BaseModel):
    entity_type: str
    embedding: list[float]                           # always EMBED_DIM-dim
...
def embed(req: EmbedRequest):
    """
    Generate an L2-normalised embedding from raw entity data.
