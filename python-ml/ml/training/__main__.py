"""
python -m ml.training [args]

Usage:
  python -m ml.training
  python -m ml.training --data-dir ./training-data --epochs 100
  python -m ml.training --val-ratio 0.15 --patience 15 --eval-every 5
  python -m ml.training --hard-neg-every 20 --n-hard-neg 3
...
from ml.training import train, save_model, mine_hard_negatives
from ml.evaluation import evaluate_recall_ndcg
